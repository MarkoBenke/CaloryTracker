package com.benke.tracker_data

import com.benke.tracker_data.remote.OpenFoodApi
import com.benke.tracker_data.repostory.TrackerDataRepositoryImpl
import com.benke.tracker_data.response.malformedFoodResponse
...
import repostory.response.validFoodResponse
import retrofit2.Retrofit
import retrofit2.converter.moshi.MoshiConverterFactory
import java.util.concurrent.TimeUnit

class TrackerDataRepositoryImplTest {

    private lateinit var repository: TrackerDataRepositoryImpl
    ...
    fun setUp() {
        ...
        repository = TrackerDataRepositoryImpl(
