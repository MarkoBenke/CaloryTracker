...
import com.benke.tracker_presentation.search.components.SearchTextField
import com.benke.tracker_presentation.search.components.TrackableFoodItem
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.trackableFood) { food ->
                TrackableFoodItem(
                    ...
                    onAmountChange = {
                        viewModel.onEvent(SearchEvent.OnAmountForFoodChange(food.food, amount = it))
                    },
                    onTrack = {
                        keyboardController?.hide()
                        viewModel.onEvent(
